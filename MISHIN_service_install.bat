...
set BIN=%~dp0bin\
set ARGS=--wf-tcp=443,50000-65535 --wf-udp=443,50000-65535 ^
...
--filter-tcp=443 --hostlist="%~dp0list-general.txt"  --dpi-desync=fake,split2 --dpi-desync-repeats=11 --dpi-desync-fooling=md5sig --dpi-desync-fake-tls="%BIN%tls_clienthello_www_google_com.bin"
